...
jQuery.effects || (function (e, t) {
    ...
    e.effects = { effect: {}}, (function (t, i) {
        function a (e, t, i) {
            var a = c[t.type] || {}
            return e == null ? i || !t.def ? null : t.def : (e = a.floor ? ~~e : parseFloat(e), isNaN(e) ? t.def : a.mod ? (e + a.mod) % a.mod : e < 0 ? 0 : e > a.max ? a.max : e)
        }
        ...
        function s (e) {
            ...
            }), s.length ? (s.join() === '0,0,0,0' && t.extend(s, r.transparent), a) : r[e]
        }

        function n (e, t, i) {
            return i = (i + 1) % 1, 6 * i < 1 ? e + 6 * (t - e) * i : 2 * i < 1 ? t : 3 * i < 2 ? e + 6 * (t - e) * (2 / 3 - i) : e
        }
        ...
        f.style.cssText = 'background-color:rgba(1,1,1,.5)', p.rgba = f.style.backgroundColor.indexOf('rgba') > -1, m(d, function (e, t) {
            ...
            parse: function (n, o, h, l) {
                ...
                return o !== i && (n = [n, o, h, l], p = 'array'), p === 'string' ? this.parse(s(n) || r._default) : p === 'array' ? (m(d.rgba.props, function (e, t) {
                    f[t.idx] = a(n[t.idx], t)
                }), this) : p === 'object' ? (n instanceof u ? m(d, function (e, t) {
                    ...
                    m(i.props, function (e, t) {
                        ...
                        c[s][t.idx] = a(n[e], t, !0)
                    }), c[s] && e.inArray(null, c[s].slice(0, 3)) < 0 && (c[s][3] = 1, i.from && (c._rgba = i.from(c[s])))
                }), this) : i
            }, is: function (e) {
                ...
                return m(d, function (e, n) {
                    ...
                    return o && (r = s[n.cache] || n.to && n.to(s._rgba) || [], m(n.props, function (e, t) {
                        return o[t.idx] != null ? a = o[t.idx] === r[t.idx] : i
                    })), a
                }), a
            }, _space: function () {
                var e = [], t = this
                ...
                var i = u(e), s = i._space(), n = d[s], r = this.alpha() === 0 ? u('transparent') : this,
                    o = r[n.cache] || n.to(r._rgba), h = o.slice()
                return i = i[n.cache], m(n.props, function (e, s) {
                    var n = s.idx, r = o[n], l = i[n], u = c[s.type] || {}
                    l !== null && (r === null ? h[n] = l : (u.mod && (l - r > u.mod / 2 ? r += u.mod : r - l > u.mod / 2 && (r -= u.mod)), h[n] = a((l - r) * t + r, s)))
                }), this[s](h)
            }, blend: function (e) {
                ...
                var e = 'hsla(', i = t.map(this.hsla(), function (e, t) {
                    return e == null && (e = t > 2 ? 1 : 0), t && t < 3 && (e = Math.round(100 * e) + '%'), e
                })
            ...
            var t, i, a = e[0] / 255, s = e[1] / 255, n = e[2] / 255, r = e[3], o = Math.max(a, s, n),
                h = Math.min(a, s, n), l = o - h, u = o + h, d = 0.5 * u
            return t = h === o ? 0 : a === o ? 60 * (s - n) / l + 360 : s === o ? 60 * (n - a) / l + 120 : 60 * (a - s) / l + 240, i = d === 0 || d === 1 ? d : d <= 0.5 ? l / u : l / (2 - u), [Math.round(t) % 360, i, d, r == null ? 1 : r]
        }, d.hsla.from = function (e) {
            if (e[0] == null || e[1] == null || e[2] == null) return [null, null, null, e[3]]
            var t = e[0] / 360, i = e[1], a = e[2], s = e[3], r = a <= 0.5 ? a * (1 + i) : a + i - a * i, o = 2 * a - r
            ...
            u.fn[e] = function (e) {
                ...
                var s, h = t.type(e), d = h === 'array' || h === 'object' ? e : arguments, c = this[r].slice()
                return m(n, function (e, t) {
                    var i = d[h === 'object' ? e : t.idx]
                    i == null && (i = c[t.idx]), c[t.idx] = a(i, t)
                }), l ? (s = u(l(c)), s[r] = c, s) : u(c)
            }, m(n, function (i, a) {
                u.fn[i] || (u.fn[i] = function (s) {
                    var n, r = t.type(s), o = i === 'alpha' ? this._hsla ? 'hsla' : 'rgba' : e, l = this[o](),
                        u = l[a.idx]
                    return r === 'undefined' ? u : (r === 'function' && (s = s.call(this, u), r = t.type(s)), s == null && a.empty ? this : (r === 'string' && (n = h.exec(s), n && (s = u + parseFloat(n[2]) * (n[1] === '+' ? 1 : -1))), l[a.idx] = s, this[o](l)))
                })
            })
        }), m(o, function (e, i) {
            t.cssHooks[i] = {
                set: function (e, a) {
                    var n, r, o = ''
                    if (t.type(a) !== 'string' || (n = s(a))) {
                        if (a = u(n || a), !p.rgba && a._rgba[3] !== 1) {
                            for (r = i === 'backgroundColor' ? e.parentNode : e; (o === '' || o === 'transparent') && r && r.style;) {
                                try {
                                    o = t.css(r, 'backgroundColor'), r = r.parentNode
                                } catch (h) {
                                }
                            }
                            a = a.blend(o && o !== 'transparent' ? o : '_default')
                        }
                        a = a.toRgbaString()
                    }
                    try {
        ...
        function i () {
            var t, i,
                ...
                s = {}
            if (a && a.length && a[0] && a[a[0]]) for (i = a.length; i--;)t = a[i], typeof a[t] === 'string' && (s[e.camelCase(t)] = a[t]); else for (t in a) typeof a[t] === 'string' && (s[t] = a[t])
            return s
        }
        ...
        e.each(['borderLeftStyle', 'borderRightStyle', 'borderBottomStyle', 'borderTopStyle'], function (t, i) {
            e.fx.step[i] = function (e) {
                (e.end !== 'none' && !e.setAttr || e.pos === 1 && !e.setAttr) && (jQuery.style(e.elem, i, e.end), e.setAttr = !0)
            }
            ...
            _addClass: e.fn.addClass, addClass: function (t, i, a, s) {
                ...
                return typeof a === 'boolean' || a === t ? s ? e.effects.animateClass.call(this, a ? { add: i } : { remove: i }, s, n, r) : this._toggleClass(i, a) : e.effects.animateClass.call(this, { toggle: i }, a, s, n)
        ...
        function s (t, i, a, s) {
            return e.isPlainObject(t) && (i = t, t = t.effect), t = { effect: t }, i == null && (i = {}), e.isFunction(i) && (s = i, a = null, i = {}), (typeof i === 'number' || e.fx.speeds[i]) && (s = a, a = i, i = {}), e.isFunction(a) && (s = a, a = null), i && e.extend(t, i), a = a || i.duration, t.duration = e.fx.off ? 0 : typeof a === 'number' ? a : a in e.fx.speeds ? e.fx.speeds[a] : e.fx.speeds._default, t.complete = s || i.complete, t
        }

        function n (t) {
            return !t || typeof t === 'number' || e.fx.speeds[t] ? !0 : typeof t !== 'string' || e.effects.effect[t] ? !1 : i && e.effects[t] ? !1 : !0
        }

        e.extend(e.effects, {
            version: '1.9.2', save: function (e, t) {
                for (var i = 0; t.length > i; i++)t[i] !== null && e.data(a + t[i], e[0].style[t[i]])
            }, restore: function (e, i) {
                var s, n
                for (n = 0; i.length > n; n++)i[n] !== null && (s = e.data(a + i[n]), s === t && (s = ''), e.css(i[n], s))
                ...
                return t.wrap(a), (t[0] === n || e.contains(t[0], n)) && e(n).focus(), a = t.parent(), t.css('position') === 'static' ? (a.css({ position: 'relative' }), t.css({ position: 'relative' })) : (e.extend(i, {
            ...
            effect: function () {
                function t (t) {
                    ...
                    (s.is(':hidden') ? r === 'hide' : r === 'show') ? i() : o.call(s[0], a, i)
                }
                ...
                if (n(t) || typeof t === 'boolean' || e.isFunction(t)) return this.__toggle.apply(this, arguments)
        ...
        e.each(['Quad', 'Cubic', 'Quart', 'Quint', 'Expo'], function (e, i) {
            ...
            Sine: function (e) {
                ...
                return e === 0 || e === 1 ? e : -Math.pow(2, 8 * (e - 1)) * Math.sin((80 * (e - 1) - 7.5) * Math.PI / 15)
            }, Back: function (e) {
                return e * e * (3 * e - 2)
            }, Bounce: function (e) {
